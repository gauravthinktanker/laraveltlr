...
<div class="content-wrapper">
  <div class="row">
    ...
    <?= Form::model($aptitude_edit, array('route' => ['aptitude.update', $aptitude_edit->id], 'class' => 'form-horizontal', 'method' => 'put', 'files' => true)) ?>
      <div class="add-client bg-white rounded">
        ...
        <div class="row p-20">
          <div class="card-body">
            ...
            <label for="companyname" class="col-sm-2 mt-2 form-label">Questions</label>
              <div class="col-sm-9">
              <?= Form::text('question', old('question'), ['class' => 'form-control height-35 f-14', 'placeholder' => 'Quiz Question']); ?>
        ...
        <button type="submit" class="btn-primary rounded f-14 p-2 mr-3" id="submit" name="save_button" value="save_new"><svg class="svg-inline--fa fa-check fa-w-16 mr-1" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
          ...
          <a href="<?= URL::route('aptitude') ?>" class="btn-cancel rounded f-14 p-2 border-0"> Cancel</a>
        </div>
        {!! Form::close() !!}
      </div>
    </div>
